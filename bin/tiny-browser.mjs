...
const COMMANDS = [
  ...
  {
    name: 'type',
    params: '{"text":"value"[,"x":N,"y":N,"tabId":N]}',
    returns: '{"ok":true,"screenshot":"..."}',
    desc: 'Type text with human-like timing. Omit x/y to type into the currently focused element. Note: may not work on React-controlled inputs in background tabs — prefer URL params for search boxes.',
    auto_screenshot: true,
  },
  {
    name: 'key_press',
